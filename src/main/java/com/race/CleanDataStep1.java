...
public class CleanDataStep1 extends Configured implements Tool {
...
//            if(ToolRunner.run(conf, new CleanDataStep1(), args)==0){
                ToolRunner.run(conf, new CleanDataStep1(), args);
//            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    static class TestMapper1 extends Mapper<LongWritable, Text, Text, Text> {
        ...
        protected void setup(Context context) throws IOException, InterruptedException {
            ...
            //读入手机型号作为判断
            InputStream inputStream = CleanDataStep1.class.getResourceAsStream("/moblietype.txt");
            InputStream inputStream1 = CleanDataStep1.class.getResourceAsStream("/moblietype1.txt");
        ...
        protected void map(LongWritable key, Text value,
             ...
             */
                ...
                String zong = version + "," + net + "," + sex + "," + age + "," + arpu + "," + data + "," + phone + "," + sms + "," + os+","+ modelx;
                for (int i = 0; i <12 ; i++) {
