        ...
        static
        {
            ...
            try
            {
                ...
                p.load(new InputStreamReader(Predefine.HANLP_PROPERTIES_PATH == null ?
                        ...
                        , "UTF-8"));
                String pa = loader.getResource("").getPath();
//                String root = pa.replaceAll("\\\\", "/");
                String root;
                String ci=p.getProperty("ciku", "");
                boolean ciku= !"1".equals(ci);
                if(!ciku){
                    root = pa.replaceAll("\\\\", "/");
                }else{
                     root = p.getProperty("root", "").replaceAll("\\\\", "/");
                }
                System.out.println(ciku);
 ...
 //********************************************************
                ...
                CoreDictionaryPath =ciku?p.getProperty("CoreDictionaryPath", CoreDictionaryPath) : (root + p.getProperty("CoreDictionaryPath", CoreDictionaryPath));
                CoreDictionaryTransformMatrixDictionaryPath =ciku? p.getProperty("CoreDictionaryTransformMatrixDictionaryPath", CoreDictionaryTransformMatrixDictionaryPath):(root + p.getProperty("CoreDictionaryTransformMatrixDictionaryPath", CoreDictionaryTransformMatrixDictionaryPath));
                BiGramDictionaryPath =ciku? p.getProperty("BiGramDictionaryPath", BiGramDictionaryPath):(root + p.getProperty("BiGramDictionaryPath", BiGramDictionaryPath));
                CoreStopWordDictionaryPath =ciku? p.getProperty("CoreStopWordDictionaryPath", CoreStopWordDictionaryPath):(root + p.getProperty("CoreStopWordDictionaryPath", CoreStopWordDictionaryPath));
                CoreSynonymDictionaryDictionaryPath =ciku? p.getProperty("CoreSynonymDictionaryDictionaryPath", CoreSynonymDictionaryDictionaryPath):(root + p.getProperty("CoreSynonymDictionaryDictionaryPath", CoreSynonymDictionaryDictionaryPath));
                PersonDictionaryPath = ciku?p.getProperty("PersonDictionaryPath", PersonDictionaryPath):(root + p.getProperty("PersonDictionaryPath", PersonDictionaryPath));
                PersonDictionaryTrPath =ciku? p.getProperty("PersonDictionaryTrPath", PersonDictionaryTrPath):(root + p.getProperty("PersonDictionaryTrPath", PersonDictionaryTrPath));
                String[] pathArray =ciku? p.getProperty("CustomDictionaryPath", "data/dictionary/custom/CustomDictionary.txt").split(";"):(p.getProperty("CustomDictionaryPath", "data/dictionary/custom/CustomDictionary.txt").split(";"));
...
//                String[] pathArray = p.getProperty("CustomDictionaryPath", "data/dictionary/custom/CustomDictionary.txt").split(";");
 ...
 //***************************修改词典要注释下面代码
                ...
                TraditionalChineseDictionaryPath =ciku? p.getProperty("TraditionalChineseDictionaryPath", TraditionalChineseDictionaryPath):(root + p.getProperty("TraditionalChineseDictionaryPath", TraditionalChineseDictionaryPath));
                SYTDictionaryPath =ciku? p.getProperty("SYTDictionaryPath", SYTDictionaryPath):(root + p.getProperty("SYTDictionaryPath", SYTDictionaryPath));
                PinyinDictionaryPath =ciku? p.getProperty("PinyinDictionaryPath", PinyinDictionaryPath):(root + p.getProperty("PinyinDictionaryPath", PinyinDictionaryPath));
                TranslatedPersonDictionaryPath = ciku?p.getProperty("TranslatedPersonDictionaryPath", TranslatedPersonDictionaryPath):(root + p.getProperty("TranslatedPersonDictionaryPath", TranslatedPersonDictionaryPath));
                JapanesePersonDictionaryPath = ciku?p.getProperty("JapanesePersonDictionaryPath", JapanesePersonDictionaryPath):(root + p.getProperty("JapanesePersonDictionaryPath", JapanesePersonDictionaryPath));
                PlaceDictionaryPath =ciku? p.getProperty("PlaceDictionaryPath", PlaceDictionaryPath):(root + p.getProperty("PlaceDictionaryPath", PlaceDictionaryPath));
                PlaceDictionaryTrPath =ciku? p.getProperty("PlaceDictionaryTrPath", PlaceDictionaryTrPath):(root + p.getProperty("PlaceDictionaryTrPath", PlaceDictionaryTrPath));
                OrganizationDictionaryPath = ciku?p.getProperty("OrganizationDictionaryPath", OrganizationDictionaryPath):(root + p.getProperty("OrganizationDictionaryPath", OrganizationDictionaryPath));
                OrganizationDictionaryTrPath =ciku? p.getProperty("OrganizationDictionaryTrPath", OrganizationDictionaryTrPath):(root + p.getProperty("OrganizationDictionaryTrPath", OrganizationDictionaryTrPath));
                CharTypePath =ciku? p.getProperty("CharTypePath", CharTypePath):(root + p.getProperty("CharTypePath", CharTypePath));
                CharTablePath =ciku? p.getProperty("CharTablePath", CharTablePath):(root + p.getProperty("CharTablePath", CharTablePath));
                WordNatureModelPath =ciku? p.getProperty("WordNatureModelPath", WordNatureModelPath):(root + p.getProperty("WordNatureModelPath", WordNatureModelPath));
                MaxEntModelPath =ciku? p.getProperty("MaxEntModelPath", MaxEntModelPath):(root + p.getProperty("MaxEntModelPath", MaxEntModelPath));
                NNParserModelPath =ciku? p.getProperty("NNParserModelPath", NNParserModelPath):(root + p.getProperty("NNParserModelPath", NNParserModelPath));
                CRFSegmentModelPath =ciku? p.getProperty("CRFSegmentModelPath", CRFSegmentModelPath):(root + p.getProperty("CRFSegmentModelPath", CRFSegmentModelPath));
                CRFDependencyModelPath =ciku? p.getProperty("CRFDependencyModelPath", CRFDependencyModelPath):(root + p.getProperty("CRFDependencyModelPath", CRFDependencyModelPath));
                HMMSegmentModelPath =ciku? p.getProperty("HMMSegmentModelPath", HMMSegmentModelPath):(root + p.getProperty("HMMSegmentModelPath", HMMSegmentModelPath));
                ShowTermNature =ciku? "true".equals(p.getProperty("ShowTermNature", "true")):("true".equals(p.getProperty("ShowTermNature", "true")));
                Normalization =ciku? "true".equals(p.getProperty("Normalization", "false")):("true".equals(p.getProperty("Normalization", "false")));
...
//***********************************************************************
    ...
    public static void delcache(){
        String pa = HanLP.class.getResource("/").getPath()+"data/dictionary/custom/CustomDictionary.txt.bin";
        if(new File(pa).canRead()){
            new File(pa).delete();
        }
    }
    /**
     * 将生成的缓存文件加入用户词典的目录下,打包的时候会读取
     */
    public static void copchche(){
        String pa = HanLP.class.getResource("/").getPath()+"data/dictionary/custom/CustomDictionary.txt.bin";
        ...
        try {
            if(new File(ou).exists()){
                new File(ou).delete();
                new File(ou).createNewFile();
            }
            forChannel(new File(pa),new File(ou));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
