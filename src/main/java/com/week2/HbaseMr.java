...
public class HbaseMr extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
       ...
       String outputPath= "/user/shangyongqiang/bisai/hbase/";
    ...
    public static void main(String[] args) {
        ...
        try {
            if(ToolRunner.run(conf, new HbaseMr(), args)==0){
                   ...
                   Map<Integer,String> cityMap = new HashMap();
                    ...
                    if( map.get("info:city")!=null){
                        ...
                        for (int i = 0; i < autos.length; i++) {
                            ...
                            text = uid + "\t" + url + "\t"+sce + "\t" + time + "\t" + pro + "\t" + autoCode + "\t" + count + "\t" + cityCode + "\t" + map.get("info:bsid");
