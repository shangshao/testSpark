 ...
 */
public class StaticticsBiz extends Configured implements Tool {
...
//        List<String> list = DateUtil.getlist(ding, path1, path2);
    ...
    public static void main(String[] args) {
        ...
        try {
                ...
                ToolRunner.run(conf, new StaticticsBiz(), args) ;
...
//            conf.set("yarn.resourcemanager.hostname", "dmp01");
    ...
    static class TestMapper1 extends Mapper<LongWritable, Text, Text, IntWritable> {
        ...
        protected void setup(Context context) throws IOException, InterruptedException {
            //读入手机型号做匹配
            InputStream inputStream = StaticticsBiz.class.getResourceAsStream("/moblietype.txt");
