 ...
 * 需要爬虫手机型号的数据库
 */
public class Statictics_Mobile extends Configured implements Tool {
...
//        List<String> list = DateUtil.getlist(ding, path1, path2);
    ...
    public static void main(String[] args) {
        ...
        try {
                ...
                ToolRunner.run(conf, new Statictics_Mobile(), args) ;
...
//            conf.set("yarn.resourcemanager.hostname", "dmp01");
    ...
    static class TestMapper1 extends Mapper<LongWritable, Text, Text, IntWritable> {
        ...
        protected void setup(Context context) throws IOException, InterruptedException {
            //读入手机型号做匹配
            InputStream inputStream = Statictics_Mobile.class.getResourceAsStream("/moblietype.txt");
