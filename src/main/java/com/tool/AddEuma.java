...
/**
 * Created by shangyongqiang on 2016/8/2.
 */
public class AddEuma {
    ...
    public static <T extends Enum<?>> void addEnum(Class<T> enumType, String enumName) {
        ...
        Field[] fields = Nature.class.getDeclaredFields();
...
//        addEnum(Nature.class , "d");
//        addEnum(Nature.class , "e");
//        addEnum(Nature.class , "shang");

        // Run a few tests just to show it works OK.
//        System.out.println(Arrays.deepToString(Nature.values()));
        // Shows : [a, b, c, d, e, f]
    }
